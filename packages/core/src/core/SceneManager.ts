...
export class SceneManager {
    ...
    public async transitionToScene(sceneId: SceneId, state: GameState, engine: GameEngine): Promise<boolean> {
        try {
            const targetScene = await this.contentLoader.loadScene(sceneId);
